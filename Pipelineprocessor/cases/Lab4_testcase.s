    ...
    nop
    add t2 x0 x0
right_branch_1: beq t2 x0 error1 # shouldn't branch
    nop
    nop
    ...
    nop
error1: add t0 x0 x0
right_branch_2: bne t2 t0 error2 # shouldn't branch
    nop
    nop
    ...
    nop
error2: add t1 x0 x0
right_branch_3: blt t1 t4 error3 #shouldn't branch
    nop
    nop
    ...
    nop
error3: add t3 x0 x0
right_branch_4: add t4 x0 x0 # now t0=t2=0xffcd8000, t1=0x00000c98, t3=0x00000002, t4=0x0
    jal x1 memory_test # ra=0x000000fc
    nop
    nop
    beq t0 t2 exit # should branch
    nop
    nop
memory_test: sw t0 0(sp)
    sb t1 4(sp)
    lw t4 0(sp)
    lb t4 4(sp)
    lbu t4 4(sp)
